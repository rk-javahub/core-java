...
public class FilterDemo {
    public static void main(String[] args) {
        ...
        System.out.println("------------------ Getting employee based on name and salary in ascending order using sorted() -------------------------");
        employees.stream().sorted(Comparator.comparing(Employee::getName).thenComparing(Employee::getSalary)).toList().forEach(System.out::println);
        System.out.println("\n");
